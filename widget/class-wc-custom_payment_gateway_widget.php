...
class WC_Custom_Payment_Gateway_2 extends WC_Payment_Gateway {
    ...
    public function __construct() {
        ...
        $this->method_title   = __( 'Card Payments ZottoPay', 'wcwcCpg2' );
        $this->method_description = __( 'For VISA , MasterCard, Maestro , AMEX ,Diners Card Payments', 'wcwcCpg2' );
    ...
    function admin_options() {
        ?>
        <h3><?php _e('ZottoPay Card Payment Settings','ncgw2'); ?></h3>
    ...
    public function init_form_fields() {
        ...
        $this->form_fields = array(
            'enabled' => array(
                ...
                'type' => 'checkbox',
                'label' => __( 'Enable ZottoPay', 'wcwcCpg2' ),
                'default' => 'no'
            ),
            'title' => array(
                'title' => __( 'Card Payment', 'wcwcCpg2' ),
                'type' => 'text',
                'description' => __( 'Card Payment ZottoPay.', 'wcwcCpg2' ),
                'desc_tip' => true,
                'default' => __( 'Card Payment', 'wcwcCpg2' )
            ),
            'description' => array(
                'title' => __( 'Description', 'wcwcCpg2' ),
                'type' => 'textarea',
                'description' => __( 'This controls the description which the user sees during checkout.', 'wcwcCpg2' ),
                'default' => __( 'Pay with zotto pay. We accept all credit card, debit card  payment', 'wcwcCpg2' )
            ),
            'instructions' => array(
                'title' => __( 'Instructions', 'wcwcCpg2' ),
                'type' => 'textarea',
                'description' => __( 'Instructions that will be added to the thank you page.', 'wcwcCpg2' ),
                'default' => __( 'Instructions', 'wcwcCpg2' )
            ),
            'api-key' => array(
                'title' => __( 'API Key', 'wcwcCpg2' ),
                'type' => 'text',
                'description' => __( 'Your API key.', 'wcwcCpg2' ),
                'default' => __( '', 'wcwcCpg2' )
            ),'secret-key' => array(
                'title' => __( 'Secret Key', 'wcwcCpg2' ),
                'type' => 'text',
                'description' => __( 'Your Secret key.', 'wcwcCpg2' ),
                'default' => __( '', 'wcwcCpg2' )
            ),'order-status' => array(
    ...
    function thankyou_page() {
       ...
       //if(get_post_meta($order_id, '_payment_method', true)=='ncgw2') {
         //   $order->update_status($this->order_status,'Order Placed Successfully');
        //}else{
        //    return;
        //}
